...
<li {{ $attributes->class('border-t border-gray-200') }}>
    <a href="{{ $job->url }}" class="block hover:bg-gray-50 focus:outline-none focus:bg-gray-50 transition duration-150 ease-in-out">
        <div class="relative px-8 py-4 flex flex-col gap-4 md:flex-row md:items-center">
                    ...
                    <div class="mt-2 flex">
                        <div class="flex flex-wrap items-center text-sm leading-5 text-gray-500 lg:space-x-4">
                            @if ($job->area || $job->city)
                                <span class="flex items-center gap-2 w-full lg:w-auto">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5 opacity-25">
            ...
            <div class="flex justify-between items-center gap-4">
                <div class="flex-shrink-0">
                    <div class="flex overflow-hidden p-3 rounded bg-gray-200">
